...
{
    private VeparaGateway $gateway;
    private MockHttpClient $httpClient;

    protected function setUp(): void
    {
        $this->gateway = new VeparaGateway();
    ...
    {
        $this->assertSame('Vepara', $this->gateway->getName());
        $this->assertSame('vepara', $this->gateway->getShortName());
    }
    ...
    public function test_successful_payment(): void
    {
        ...
        $this->assertSame('VEP-TXN-001', $response->getTransactionId());
    }
    ...
    {
        $this->httpClient->addResponse(200, ['status_code' => 100, 'transaction_id' => 'T1']);
